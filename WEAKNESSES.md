...
- 2026-08-24 — The public legal DOCX mirrors are generated by the private knowledgebase legal toolchain, so this public assets repository cannot reproduce them by itself. The Markdown files remain the canonical sources; regenerate and visually verify the Word copies through the controlled legal-document workflow whenever either source changes.
