...
// (servalabs.com and wincommander `assets/…`). Each consuming
...
// — editorial imagery —
import googleAd1999 from "../../editorial/google-ad-1999.jpeg";
import gemini from "../../editorial/gemini.png";
import humansReviewGemini from "../../editorial/humans-review-gemini.jpg";
import metaRayban from "../../editorial/meta-rayban-scandal.jpg";
import nsaPrismSlide from "../../editorial/nsa-prism-slide.png";
import chatgptNsaDirector from "../../editorial/chatgpt-nsa-director.jpg";
import clipperChip from "../../editorial/myk-78-clipper-chip-markings.jpg";
import antDropoutjeep from "../../editorial/nsa-ant-dropoutjeep.jpg";
import antCottonmouth from "../../editorial/nsa-ant-cottonmouth-i.jpg";
import muscularSlide from "../../editorial/nsa-muscular-google-cloud-slide.jpg";
import boundlessInformant from "../../editorial/boundless-informant-heat-map.svg";
import merkelPortrait from "../../editorial/angela-merkel-portrait-2011.jpg";
import utahDataCenter from "../../editorial/nsa-utah-data-center-aerial.jpg";
import ciaFrankfurt from "../../editorial/cia-frankfurt-consulate.jpg";
import natanz from "../../editorial/natanz-nuclear-facility-2006.jpg";
import antJetplow from "../../editorial/nsa-ant-jetplow.jpg";
import haydenPortrait from "../../editorial/michael-hayden-portrait.jpg";
